package {
	...
	public class JPPScrollbarKit extends MovieClip {
		...
		private function _initialize(e:Event):void {
			...
			//======================================================================
			//コンテンツの上限値, 下限値
			var upperBound:Number = body.x;
			var lowerBound:Number = body.x - (content.width - mask.width);
		...
		//	_scrollbar.stage = stage;
			...
			_scrollbar.setup(
				...
				body.width,  //スクロール対象コンテンツの総計サイズを設定します.
				mask.width,  //スクロール対象コンテンツの表示部分のサイズを設定します.
